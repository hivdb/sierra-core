...
//	 * @param seqMutations
//	 */
//	public AsiRega (HIVGene submittedGene, MutationSet seqMutations) {
...
//
//	@Override
//	public final String getDrugLevelText(HIVDrug drug) {
...
//		HIVDrugClass drugClass, HIVDrug drug, String condition, String susceptibility
//	) {
//
...
//		if (drugClass == HIVDrugClass.NRTI) {
